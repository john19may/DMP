        ...
        public void addChar(char c) throws Exception {
            ...
            while(remainder > 0) {
                ...
                if (!nodes[active_node].next.containsKey(active_edge())){
                    int leaf = newNode(position, oo); //aa rha hai
                    ...
                    if (text[nodes[next].start + active_length] == c) { //observation 1 //aa rha hai
                        active_length++;
                ...
                if (active_node == root && active_length > 0) {  //rule 1
                    ...
                    active_node = nodes[active_node].link > 0 ? nodes[active_node].link : root; //rule 3 //aa rha hai
            }
        }
